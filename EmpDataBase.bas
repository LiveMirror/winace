...
'110916 rjk: Changes for server release 4.3.34, additional DB fields melt_denom to items,
'            deity flag to sector type table, added remaining commodities to the build table
...
'010816 rjk: Added deity flag to the sector type table
If dbEmpire.TableDefs("Sector Type").Fields.Count = 31 Then
    dbEmpire.TableDefs("Sector Type").Fields.Append dbEmpire.TableDefs("Sector Type").CreateField("deity", dbBoolean)
    dbEmpire.TableDefs("Sector Type").Fields("deity").DefaultValue = False
    If dbEmpire.TableDefs("Sector Type").RecordCount > 0 Then
        Set rsSectorType = dbEmpire.OpenRecordset("Sector Type")
        rsSectorType.MoveFirst
        While Not rsSectorType.EOF
...
If dbEmpire.TableDefs("Build Info").Fields.Count = 59 Then
    ...
    End If
End If
'310716 rjk: Added Additional commodities (c,p,s,i,d,b,f,u) to Build Info table
If dbEmpire.TableDefs("Build Info").Fields.Count = 62 Then
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("civ", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("civ").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("pet", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("pet").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("shell", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("shell").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("iron", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("iron").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("dust", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("dust").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("bar", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("bar").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("food", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("food").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("UW", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("UW").DefaultValue = 0#
    dbEmpire.TableDefs("Build Info").Fields.Append dbEmpire.TableDefs("Build Info").CreateField("bwork", dbInteger)
    dbEmpire.TableDefs("Build Info").Fields("bwork").DefaultValue = 0#
    If dbEmpire.TableDefs("Build Info").RecordCount > 0 Then
        Set rsBuild = dbEmpire.OpenRecordset("Build Info")
        rsBuild.MoveFirst
        While Not rsBuild.EOF
            rsBuild.Edit
            rsBuild.Fields("civ") = 0#
            rsBuild.Fields("pet") = 0#
            rsBuild.Fields("shell") = 0#
            rsBuild.Fields("iron") = 0#
            rsBuild.Fields("dust") = 0#
            rsBuild.Fields("bar") = 0#
            rsBuild.Fields("food") = 0#
            rsBuild.Fields("UW") = 0#
            rsBuild.Fields("bwork") = 0#
            rsBuild.Update
            rsBuild.MoveNext
        Wend
    End If
...
If dbEmpire.TableDefs("Items").Fields.Count = 17 Then
    ...
    End If
End If
'270716 rjk: Added melt_denom to Items table
If dbEmpire.TableDefs("Items").Fields.Count = 19 Then
    dbEmpire.TableDefs("Items").Fields.Append dbEmpire.TableDefs("Items").CreateField("melt_denom", dbInteger)
    dbEmpire.TableDefs("Items").Fields("melt_denom").DefaultValue = 1
    If dbEmpire.TableDefs("Items").RecordCount > 0 Then
        Set rsItems = dbEmpire.OpenRecordset("Items")
        rsItems.MoveFirst
        While Not rsItems.EOF
            rsItems.Edit
            rsItems.Fields("melt_denom") = 1
            rsItems.Update
            rsItems.MoveNext
        Wend
    End If
