...
'110916 rjk: Changes for server release 4.3.34. Changevalue to power in FillGridItem.
'            Update sector build for 100% changes.  Added inefficient packing values.
...
grid1.TextMatrix(0, 2) = "$$$ - 100%"
grid1.TextMatrix(0, 3) = "lcms - 100%"
grid1.TextMatrix(0, 4) = "hcms - 100%"
grid1.TextMatrix(0, 5) = "mobility - 100%"
...
For n = 1 To grid1.Cols - 1
    ...
    grid1.CellAlignment = flexAlignRightCenter
Next n
grid1.ColWidth(0) = grid1.ColWidth(0) * 0.6
grid1.ColWidth(4) = grid1.ColWidth(4) * 1.1
grid1.ColWidth(5) = grid1.ColWidth(5) * 1.2
'Fill in rows
n = 1
If Not (rsBuild.BOF And rsBuild.EOF) Then
    rsBuild.MoveFirst
...
Else
    grid1.TextMatrix(0, 1) = "power"
    grid1.ColWidth(1) = l * 1.1
End If
grid1.CellAlignment = flexAlignRightCenter
...
grid1.col = 4
grid1.TextMatrix(0, 4) = "in pk"
grid1.CellAlignment = flexAlignLeftCenter
grid1.ColData(4) = NumericSort
grid1.ColWidth(4) = l * 1.1
grid1.col = 5
grid1.TextMatrix(0, 5) = "rg pk"
grid1.CellAlignment = flexAlignLeftCenter
grid1.ColData(5) = NumericSort
grid1.ColWidth(5) = l * 1.1
grid1.col = 6
grid1.TextMatrix(0, 6) = "wh pk"
grid1.CellAlignment = flexAlignLeftCenter
grid1.ColData(6) = NumericSort
grid1.ColWidth(6) = l * 1.1
grid1.col = 7
grid1.TextMatrix(0, 7) = "ur pk"
grid1.CellAlignment = flexAlignLeftCenter
grid1.ColData(7) = NumericSort
grid1.ColWidth(7) = l * 1.1
grid1.col = 8
grid1.TextMatrix(0, 8) = "bk pk"
grid1.CellAlignment = flexAlignLeftCenter
grid1.ColData(8) = NumericSort
grid1.ColWidth(8) = l * 1.1
grid1.col = 9
grid1.TextMatrix(0, 9) = "melt"
grid1.CellAlignment = flexAlignLeftCenter
grid1.ColData(9) = NumericSort
grid1.ColWidth(9) = l
grid1.col = 10
grid1.ColWidth(10) = l * 5
grid1.TextMatrix(0, 10) = "name"
grid1.CellAlignment = flexAlignLeftCenter
grid1.ColData(10) = TextSort
'Fill in rows
For n = 1 To Items.Count
    ...
    grid1.TextMatrix(n, 4) = CStr(Items(n).Packing(PACKING_INEFFICIENT))
    grid1.TextMatrix(n, 5) = CStr(Items(n).Packing(PACKING_REGULAR))
    grid1.TextMatrix(n, 6) = CStr(Items(n).Packing(PACKING_WAREHOUSE))
    grid1.TextMatrix(n, 7) = CStr(Items(n).Packing(PACKING_URBAN))
    grid1.TextMatrix(n, 8) = CStr(Items(n).Packing(PACKING_BANK))
    grid1.TextMatrix(n, 9) = CStr(Items(n).MeltDenomination)
    grid1.TextMatrix(n, 10) = Items(n).ItemName
Next n
