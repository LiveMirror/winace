...
'100215 rjk: Fixed periscope spotted and plane spotted parsing
...
If Not rsTeleHead.NoMatch Then
    ...
    ElseIf InStr(strLine, "ne spotted") > 0 Then
        rsTeleHead.Fields("Subject") = "Plane Overflight"
    ElseIf InStr(strLine, "pe spotted") > 0 Then
        rsTeleHead.Fields("Subject") = "Periscope Spotted"
