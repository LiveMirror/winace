...
'100215 rjk: Removed Ship Orders menu items and Update Order menu item in enableOrDisableMenus for version 4.3.32
...
If VersionCheck(4, 3, 32) <> VER_LESS Then
    mnuShipOrder.Visible = False
    mnuShipMquota.Visible = False
    mnuShipSail.Visible = False
    mnuShipUnsail.Visible = False
    mnuShipFollow.Visible = False
    mnuRefresh(8).Visible = False
End If
